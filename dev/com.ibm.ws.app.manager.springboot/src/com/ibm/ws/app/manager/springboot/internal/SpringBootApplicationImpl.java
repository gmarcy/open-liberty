...
public class SpringBootApplicationImpl extends DeployedAppInfoBase implements SpringBootConfigFactory, SpringBootApplication {
    ...
    public SpringBootApplicationImpl(ApplicationInformation<DeployedAppInfo> applicationInformation,
        ...
        try {
            ...
            mci = new SpringModuleContainerInfo(factory.getSpringBootSupport(), factory.getModuleHandler(), deployedAppServices.getModuleMetaDataExtenders("web"), deployedAppServices.getNestedModuleMetaDataFactories("web"), applicationInformation.getContainer(), null, moduleURI, moduleClassesInfo, infos);
