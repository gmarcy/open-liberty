...
public class WABInstaller implements EventHandler, ExtensionFactory, RuntimeUpdateListener {
    ...
    final class WABDeployedAppInfo extends SimpleDeployedAppInfoBase {
        ...
        ModuleContainerInfo createModuleContainerInfo(String contextRoot, Container moduleContainer,
            ...
            WebModuleContainerInfo mci = new WebModuleContainerInfo(webModuleHandlerSRRef.getServiceWithException(), deployedAppServices.getModuleMetaDataExtenders("web"), deployedAppServices.getNestedModuleMetaDataFactories("web"), moduleContainer, null, moduleURI, moduleClassesInfo, contextRoot);
